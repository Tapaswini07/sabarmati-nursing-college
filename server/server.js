...
import registrationFeeRoutes from "./routes/registrationFees.js";
import formFillUpFeeRoutes from "./routes/formFillUpFees.js";
...
app.use("/receipts", express.static("../frontend/public"));
...
app.use("/api/form-fill-up-fees", formFillUpFeeRoutes);
